...
function ConfirmApplicationPage() {
    return (
        <div>
            ...
            <p>Encourage your friends and colleagues to become Deep Tech Heroes too.</p>
            <p>Share the event on Facebook, Twitter or LinkedIn.</p>
            <p>Learn about other <Link to="/events">Events</Link> who need heroes.</p>
