    ...
    <>
      <div className="home-page">
        ...
        >
          ...
          <ButtonFilled color="accent" width="auto" icon={IconUser}>
            <div style={{ fontFamily: "Manrope" }}>Update profile to join</div>
          </ButtonFilled>
        </div>
        <div className="cover">
          <img
          ...
          <div className="above-img">
            ...
            <div style={{ paddingBottom: "32px" }}>
              Connect with a mentor or coach to achieve your potential
            </div>
