  ...
  return (
    <form className="form-wrapper">
      <div className="form-header">
        ...
        <p>
          You will need to be signed in as a Hero to be able to apply for an
          Event.
        </p>
        <p>
          Already a Hero? <Link to="/signin">Sign In</Link>
        </p>
        <p>
          Not a Hero yet? <Link to="/becomehero">Become a Hero</Link>
        </p>
      </div>
      <div className="form-inputs">
        ...
        <div className="form-input">
          <label htmlFor="reason_apply">
            Tell us why you would like to be a Hero for this Event:
          </label>
          <input
            type="text"
            id="reason_apply"
        ...
        <div className="form-input-checkbox">
          <div>
            <input
              ...
              onChange={handleChange}
            />
            <label htmlFor="is_anon">
              Would you prefer to remain anonymous to the public?
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="form-confirm">
        ...
        <div className="form-confirm-details">
          ...
          <p>
            <b>Your reason for applying to be a Hero at this Event: </b>
            {application.reason_apply}
          </p>
        </div>
