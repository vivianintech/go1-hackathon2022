  ...
  return (
    <form className="form-wrapper">
      <div className="form-header">
        <h2>Become a Host</h2>
        <p>
          Do you organise events related to Deep Tech? Become a Host to list
          your events and be found by diverse Heroes.
        </p>
        <p>
      ...
      <div className="form-inputs">
        ...
        <div className="button-area">
          <button type="cancel" onClick={handleHostCancel}>
            CANCEL
          </button>
          <button type="submit" onClick={handleHostSubmit}>
            SUBMIT
          </button>
        </div>
      </div>
