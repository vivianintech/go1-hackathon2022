        ...
        <form className="form-wrapper">
            ...
            <div className="form-inputs">
                ...
                <div id="new-event">
                    ...
                    <label id="input-radio-1" htmlFor='is_paid'>Payment Negotiable</label>
                    ...
                    <label id="input-radio-1" htmlFor='is_paid'>ProBono Opportunity</label>
                ...
                <div className="form-input-checkbox">
                    ...
                    <div className="1">
                        <input
                            ...
                            onChange={handleChange}
                        />
                        <label className="input-checkbox" htmlFor='skills_keynote'>Keynote Speaker</label>
                    </div>  
                    ...
                    <div className="1">
                        <input
                            ...
                            onChange={handleChange}
                        />
                        <label className="input-checkbox" htmlFor='skills_facilitator'>Workshop Facilitator</label>
                    ...
                    <div className="1">
                        <input
                            ...
                            onChange={handleChange}
                        />
                        <label className="input-checkbox" htmlFor='skills_mentor'>Supportive Mentor</label>
                    </div>
                    ...
                    <div className="1">
                        <input
                            ...
                            onChange={handleChange}
                        />
                        <label className="input-checkbox" htmlFor='skills_expert'>Topic Expert</label>
                    </div>
                    ...
                    <input
                        ...
                        onChange={handleChange}
                    />
                    <label className="input-checkbox" htmlFor='skills_enthusiast'>Deep Tech Enthusiast</label>
                    </div>        
            ...
            <div className="form-confirm">
                ...
                <div className="form-confirm-details">
                    ...
                    <p><b>Keynote Speaker: </b>{ event.skills_keynote }</p>
                    <p><b>Workshop Facilitator: </b>{ event.skills_facilitator }</p>
                    <p><b>Supportive Mentor: </b>{ event.skills_mentor }</p>
                    <p><b>Topic Expert: </b>{ event.skills_expert }</p>
                    <p><b>Tech Enthusiast: </b>{ event.skills_enthusiast }</p>
                    <p><b>Event Size: </b>{ event.event_size }</p>
                    <p><b>Payment available: </b>{ event.is_paid }</p>
                    <p><b>Event Image: </b>{ event.image }</p>
                </div>
